...
import library.DeleteFrame.GetbackListener;
import library.DeleteFrame.SelectListener;

public class UpdateFrame1 extends JFrame {
    ...
    private JButton selectButton, getbackButton, updateButton;
    private JList list;
    private long userId;
    private JScrollPane scroll;

    public UpdateFrame1(long userId) {
        super("欢迎您来到更新图书界面");
        this.userId = userId;
        this.setLayout(null);
        Vector<String> publisherInfo = Service.getPublisher();
        showLabel = new JLabel("更新图书");
        ...
        hintLabel2.setBounds(0, 350, 240, 50);
        scroll.setBounds(30, 400, 940, 320);
        getbackButton.setBounds(25, 25, 80, 50);
        updateButton.setBounds(450, 720, 100, 40);
    ...
    public class UpdateListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if(bookValue == null) {
                JOptionPane.showMessageDialog(null, "请先进行检索，然后在选择一本图书！");
                return ;
            }
            UpdateFrame update = new UpdateFrame(userId,bookValue);
            dispose();
